...
<script src="javascript/learnmore.js?v=11"></script>
</head>
<body data-bs-spy="scroll">
   <div id="container">
      ...
      <?php
         ...
         <a href="./viewprofile.php"><img src="user_images/'.$row['image'].'" id="profile" alt="" width="50" height="75"></a>
      </div>';
...
<p>Jf</p></a>
   ...
   <?php
      ...
      ?>
      <div id="wb_hireme">
         <a class="ui-button ui-corner-all" id="hireme" href="./hireme.php">Hire me - Profile</a>
      </div>
      <?php
